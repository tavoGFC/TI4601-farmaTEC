...
--Type_Medicament--
CREATE TABLE [dbo].[Medicament_Type]
(
    [Type_Id] [int] IDENTITY(1,1) NOT NULL,
    [Type_Description] [varchar](300) NOT NULL,
    CONSTRAINT [PK_Medicament_Type] PRIMARY KEY CLUSTERED ( [Type_Id] ASC ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO

--Secondary_Effect Medicament--
CREATE TABLE [dbo].[Scondary_Effect]
(
    [Scondary_Effect_Id] [int] IDENTITY(1,1) NOT NULL,
    [SE_Description] [varchar](300) NOT NULL,
    CONSTRAINT [PK_Scondary_Effect] PRIMARY KEY CLUSTERED ( [Scondary_Effect_Id] ASC ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
(
    ...
    [Medicament_Type_Id] [int] NOT NULL,
    [Dose] [varchar](300) NOT NULL,
    [Photo] [image] NOT NULL,
    [Price] [int] NOT NULL,
    CONSTRAINT [PK_Medicament] PRIMARY KEY CLUSTERED ([Medicament_Id] ASC) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
    CONSTRAINT FK_Medicament_Type FOREIGN KEY ( Medicament_Type_Id ) REFERENCES [dbo].[Medicament_Type] ([Type_Id])
) ON [PRIMARY]
GO

--Medicament |X| Secondary_Effect--
CREATE TABLE dbo.Medicament_SecondaryEffect
(
    Medicament_SecondaryEffect_Id int IDENTITY(1,1) NOT NULL,
    Medicament_Id int NOT NULL,
    Secondarty_Effect_Id int NOT NULL,
    CONSTRAINT [PK_M_SE] PRIMARY KEY CLUSTERED (Medicament_SecondaryEffect_Id ASC) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
    CONSTRAINT FK_Medicament_Id FOREIGN KEY ( Medicament_Id ) REFERENCES [dbo].[Medicament] ([Medicament_Id]),
    CONSTRAINT FK_Secondary_Effect_Id FOREIGN KEY ( Secondarty_Effect_Id ) REFERENCES [dbo].[Scondary_Effect] ([Scondary_Effect_Id])
)  
	ON [PRIMARY]
GO
...
(
    ...
    CONSTRAINT FK_Inventory_Medicament FOREIGN KEY ( Medicament_Id ) REFERENCES [dbo].[Medicament] ([Medicament_Id]),
...
(
    ...
    CONSTRAINT FK_Order_Medicament FOREIGN KEY ( [Medicament_Id] ) REFERENCES [dbo].[Medicament] (Medicament_Id)
) ON [PRIMARY]
GO
