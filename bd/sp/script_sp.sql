...
BEGIN
	...
	VALUES	(@ID, @first_name, @last_name1, @last_name2, @password)
END
GO
...
BEGIN
	...
	VALUES	(@id, @first_name, @last_name1, @last_name2, @account_id, @phone_number, @type, @city, @password)
END
GO
...
BEGIN
	...
	VALUES	(@id, @name, @city, @phone_number, @schedule_id, @admin_id)
END
GO
...
AS
BEGIN
	INSERT INTO [Product](Pd_ID, Pd_Name, Pd_Brand, Pd_Type, Pd_Description, Pd_Kid_Dose, Pd_Adult_Dose, Pd_Side_Effects, Pd_Picture_ID, Pd_Price, Pd_Stock)
	VALUES	(@id, @name, @brand, @type, @description, @kid_dose, @adult_dose, @side_effects, @picture_id, @price, @stock)
END
GO
...
AS
BEGIN
	INSERT INTO [Order](Or_ID, Or_Date, Or_Client_ID, Or_State, Or_Type, Or_Pharmacy_ID, Pd_ID, Pd_Quantity, Price)
	VALUES	(@id, @date, @client_id,@state, @type, @pharmacy_id, @product_id, @quantity, @price)
END
GO
...
AS
BEGIN
	SELECT * FROM [Employee] WHERE Emp_First_Name = @name
END
GO
...
AS
BEGIN
	SELECT * FROM [Employee] WHERE Emp_Last_Name_1 = @last_name
END
GO
...
AS
BEGIN
	SELECT * FROM [Employee] WHERE Emp_Last_Name_2 = @last_name
END
GO
...
AS
BEGIN
	SELECT * FROM [Employee] WHERE Emp_Password = @pass
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_First_Name = @name
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Last_Name_1 = @last_name
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Last_Name_2 = @last_name
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Account_ID = @account_id
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Phone_Number = @phone_number
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Type = @type
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_City = @city
END
GO
...
AS
BEGIN
	SELECT * FROM [Client] WHERE Cl_Password = @pass
END
GO
...
AS
BEGIN
	SELECT * FROM [Schedule] WHERE Sc_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Schedule] WHERE Sc_Open_Hour = @open
END
GO
...
AS
BEGIN
	SELECT * FROM [Schedule] WHERE Sc_Close_Hour = @close
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_Legal_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_Name = @name
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_City = @city
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_Phone_Number = @phone_number
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_Schedule_ID = @schedule_id
END
GO
...
AS
BEGIN
	SELECT * FROM [Pharmacy] WHERE Ph_Admin_ID = @admin_ID
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Brand = @brand
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Type = @type
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Description = @description
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Kid_Dose = @kid_dose
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Adult_Dose = @adult_dose
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Side_Effects = @side_effects
END
GO
...
AS
BEGIN
	SELECT * FROM [Product] WHERE Pd_Price = @price
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_Date = @date
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_Client_ID = @client_id
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_State = @state
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_Type = @type
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Or_Pharmacy_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Pd_ID = @id
END
GO
...
AS
BEGIN
	SELECT * FROM [Order] WHERE Price = @price
END
GO
